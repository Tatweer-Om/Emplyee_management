...
@section('main')
    ...
    <div class="main-content">
        ...
        <div>
            <div class="modal fade user_modal modal-lg" id="user_modal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-body">
                            <form class="add_user" id="add_user" method="POST" action="#">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        <label for="leaves" class="col-form-label leaves">الإجازات</label>
                                        <input type="text" class="leaves form-control" name="leaves" id="leaves">
                                    </div>
                                    <div class="col-lg-4 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        <label for="switch6">السماح بالوصول لجميع الفروع</label><br>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <label for="user_detail" class="col-form-label">تفاصيل المستخدم</label>
                                        <textarea class="user_detail form-control" name="user_detail" id="user_detail"></textarea>
                                    </div>
                                </div>
