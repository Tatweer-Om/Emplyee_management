                                        ...
                                        <div class="timeline">
                                            <div class="timeline-container">
                                                                    ...
                                                                    <div class="timeline-text">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <img src="{{ asset('images/small/img-2.jpg')}}"
                                                                                ...
                                                                                width="60">
                                                                            <img src="{{ asset('images/small/img-5.jpg')}}"
                                                                                alt="" class="img-fluid rounded"
                                                                                width="60">
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="event-content">
                                                                    <div class="timeline-text">
                                                                        ...
                                                                        <p class="mb-0 mt-2 pt-1 text-muted">Suspendisse
                                                                            tempor porttitor elit non
                                                                            maximus. Sed suscipit, purus in convallis
                                                                            condimentum, risus ex
                                                ...
                                                <div class="timeline-launch">
                                                    <div class="timeline-box">
                                                        <div class="timeline-text">
                                                            <h3 class="font-size-18">Launched our company on 21 June 2021
                                                            </h3>
