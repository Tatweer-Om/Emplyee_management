...
@section('main')
                            ...
                            <div class="card-body px-0">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane show active" id="transactions-all-tab" role="tabpanel">
                                        {{-- <a href="#" class="btn btn-success"  href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#company_modal5" >Add Company</a> <br><br> --}}
                                            ...
                                            <table class="table align-middle datatable dt-responsive table-check nowrap"
                                                ...
                                                <thead>
                                                    <tr class="bg-transparent">
                                                        ...
                                                        <th style="text-align:center;">الحالة</th>
                                                        <th style="width: 30px; text-align:center;">الإجراء</th>                                                    </tr>
    ...
    <div class="modal fade renew_modal" id="renew_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalScrollableTitle">Renew Document</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    {{-- <div class="row">
                        ...
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Document name  </span>
                                        <span class="text-muted mb-3 lh-1 d-block text-truncate"> Expiry Date  </span>
